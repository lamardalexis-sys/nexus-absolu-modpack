...
| Chaotic | 524,288 | 10,000,000 | 100,000,000,000 | 80,000,000 | 8 |
| Neutronium | 8,388,608 | 1,000,000,000 | 10,000,000,000,000 | 8,000,000,000 | 8-9 |
| Infinity | 16,777,216 | 250,000,000,000 | 2,500,000,000,000,000 | 2,000,000,000,000 | 9 |

Note: Draconic Energy Core T8 = 9.223 Quintillion RF
→ 10 panneaux Infinity = ~2 jours AFK pour remplir (quête WTF légende)
→ 50 panneaux = ~10 heures (tryhard)
