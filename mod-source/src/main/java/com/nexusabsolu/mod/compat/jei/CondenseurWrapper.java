...
public class CondenseurWrapper implements IRecipeWrapper {
    ...
    public void getIngredients(IIngredients ingredients) {
        ...
        if (inputItem != null) {
            inputs.add(new ItemStack(inputItem, 1, recipe.inputMeta)); // CM 1
            inputs.add(new ItemStack(inputItem, 1, recipe.inputMeta)); // CM 2
        }
        inputs.add(new ItemStack(recipe.key));      // Key
        inputs.add(new ItemStack(recipe.catalyst));  // Catalyst
