...
public class FurnaceGuiHandler implements IAdvancedGuiHandler<GuiFurnaceNexus> {
    ...
    public List<Rectangle> getGuiExtraAreas(GuiFurnaceNexus gui) {
        ...
        // Panneau CONFIG (ouvert a gauche, 150x185) - seulement si configOpen
        if (gui.isConfigOpen()) {
            ...
            areas.add(new Rectangle(
                ...
                190                   // CONFIG_H + 5 marge
            ));
        }

        // Panneau UPGRADES : SUPPRIME en v1.0.210 (refonte Mekanism-style,
        // clic onglet Upgrades ouvre maintenant un GUI dedie GuiFurnaceUpgrades
        // a la place d'un side-panel). JEI n'a plus rien a eviter de ce cote.
